...
function SideNavigation() {
  return (
    <div className={styles.container + " flex_column_center "}>
      <Link href="user/upload">
        <Image src="/upload.png" width={30} height={30} alt="upload"></Image>
      </Link>
      <Link href="user/message">
        <Image src="/message.png" width={30} height={30} alt="message"></Image>
      </Link>
      <Link href="user/explore">
        <Image src="/explore.png" width={30} height={30} alt="explore"></Image>
      </Link>
